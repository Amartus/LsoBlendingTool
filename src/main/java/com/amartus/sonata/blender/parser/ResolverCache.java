...
/**
 * Modified version of {@link io.swagger.v3.parser.ResolverCache}
 */
public class ResolverCache extends io.swagger.v3.parser.ResolverCache {
    ...
    public ResolverCache(OpenAPI openApi, List<AuthorizationValue> auths, String parentFileLocation, Set<String> resolveValidationMessages, DeserializerProvider provider) {
        this(openApi, auths, parentFileLocation, resolveValidationMessages, new ParseOptions(), provider);
    }

    public ResolverCache(OpenAPI openApi, String parentFileLocation,
                         ParseOptions parseOptions, DeserializerProvider provider) {
        this(openApi, null, parentFileLocation, new HashSet<>(), parseOptions, provider);
    }

    public ResolverCache(OpenAPI openApi, List<AuthorizationValue> auths, String parentFileLocation, Set<String> resolveValidationMessages, ParseOptions parseOptions, DeserializerProvider provider) {
        super(openApi, auths, parentFileLocation, resolveValidationMessages, parseOptions);
